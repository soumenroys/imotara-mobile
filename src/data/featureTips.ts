...
export const FEATURE_TIPS: FeatureTip[] = [
  ...
  { id: "long_press",        emoji: "👆", title: "Message options",          tip: "Tap ⋯ under a reply, or long-press any message, for react, bookmark, timestamp, export and delete.", category: "chat" },
  ...
  { id: "connect_wallet",    emoji: "💳", title: "Recharge per companion",   tip: "Recharge minutes directly with the companion you want to talk to — sessions are billed per minute from your balance with that companion.", category: "settings" },
  ...
  { id: "connect_dormancy",  emoji: "🏦", title: "Old balance never expires", tip: "If you have a leftover balance from before wallet top-ups were retired, it stays active for 2 years and is never zeroed — even dormant balances are preserved with a 1-year grace refund period.", category: "settings" },
